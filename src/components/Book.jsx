    ...
    return (
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-3 text-xs lg:text-sm">
            ...
            <button
            onClick={handleFavOrNot}
                className={`flex min-w-[132px] items-center justify-center gap-1 rounded-md ${isFavorite ?  ' bg-[#DC2954]/[14%] py-1.5 text-[#DC2954] transition-all hover:bg-[#DC2954]/[24%]' : ' bg-[#1C4336]/[14%] py-1.5 text-[#1C4336] transition-all hover:bg-[#1C4336]/[24%]' } lg:py-1.5`}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
